...
public class CollinearTest
{
   ...
   /* @Test
    public void sortTest()
    {
    	...
    	int [] a1 = {2,4,6,1,3,5,7};
    	
    	assertEquals("sort"+ Arrays.toString(a1)+ ")", expectedResult, Collinear.sort(a1));
    } */
   
    @Test
    public void binarySearchTestTrue()
    {
    	int [] a1 = {1,2,3,4,5,6};
    	Boolean expectedResult = true;
    	int x = 2;
    	
    	assertEquals("binarySearch("+ Arrays.toString(a1)+","+ x +")", expectedResult, Collinear.binarySearch(a1, x));
    	
    }
    
    @Test
    public void binarySearchTestFalse()
    {
    	int [] a1 = {1,2,3,4,5,6};
